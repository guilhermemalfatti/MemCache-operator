...
controller: manifests kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
	cd config/manager && $(KUSTOMIZE) edit set image controller=${IMG}
namespace: manifests kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
